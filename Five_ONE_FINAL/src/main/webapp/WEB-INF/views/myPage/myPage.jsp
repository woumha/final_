		...
		<div id="profile_box">
			<div id="profile_icon">
				<a href="<%=request.getContextPath() %>/channel.do?mc=${m_channel.getChannel_code() }">
					<img src="${pageContext.request.contextPath}/resources/img/${m_channel.getChannel_profil() }">
				</a>
			</div>
					...
					<div class="video_box">
						...
						<p class="video_channel_p">
							<a href="<%=request.getContextPath() %>/channel.do?mc=${h_dto.getChannel_code() }">
								<img class="channel_profil" src="${pageContext.request.contextPath}/resources/img/${h_dto.getChannel_profil() }">&nbsp;${h_dto.getChannel_name() }
							</a>
						</p>
				...
				<c:forEach items="${good }" var="g_dto" begin="0" end="4" step="1">
					...
					<p class="video_channel_p">
						<a href="<%=request.getContextPath() %>/channel.do?mc=${g_dto.getChannel_code() }">
							<img class="channel_profil" src="${pageContext.request.contextPath}/resources/img/${g_dto.getChannel_profil() }">&nbsp;${g_dto.getChannel_name() }
						</a>
					</p>
